...
namespace PoolWarsV0.Data.Migrations
{
    ...
    [Migration("20220814120530_WhitelistUpdate")]
    partial class WhitelistUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PoolWarsV0.Data.Models.WalletSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PoolWarsV0.Data.Models.WhitelistedUserDao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("CanMintTotal")
                        .HasColumnType("integer");

                    b.Property<int>("MintedAmount")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PoolWarsV0.Data.Models.WalletSubmission", b =>
                {
                    b.HasOne("PoolWarsV0.Data.Models.PoolUserDao", "User")
                        .WithOne("WalletSubmission")
                        .HasForeignKey("PoolWarsV0.Data.Models.WalletSubmission", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PoolWarsV0.Data.Models.WhitelistedUserDao", b =>
                {
                    b.HasOne("PoolWarsV0.Data.Models.MintStageDao", "Stage")
                        .WithMany("WhitelistedUsers")
