...
export const Roadmap = () => {
    return <>
        ...
        <Text padding="8px 0px" fontWeight="400" fontSize="16px" lineHeight="24px">Creating unique <b>Warlord’s Card NFT</b> and launching <b>airdrop of 10,000 cards</b>.</Text>
