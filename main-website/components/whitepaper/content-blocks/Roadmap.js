...
export const Roadmap = () => {
    return <>
        ...
        <Text padding="24px 0px 8px" fontWeight="700" fontSize="24px" lineHeight="36px">Mint of Elder Katts Collection.</Text>
        <Text padding="8px 0px">First hours of mint will be reserved for <b>OG Katts</b> and <b>Whitelisted Katts</b>, after this everyone will get a chance to mint their own Katt.</Text>
        ...
        <Text padding="8px 0px">Launch of <b>&quot;Pool Wars Events&quot; v1</b>, that will be available for our community. We will be announcing <b>Staking</b> and implementing Tokenomics. Also, there will be <b>weekly raffles</b> for part of the royalties for Katt owners only.</Text>
        ...
        <Text padding="8px 0px">By <b>Elder Katts DAO</b> will be decided on important changes to the Katts ecosystem. Our team will realize the coolest and craziest ideas of our valorous community.</Text>
